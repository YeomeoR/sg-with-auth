        ...
        <StyledCards>
            ...
            <motion.div className="icon">
              ...
              <Toggle2>
                <p>
                  ...
                  buildings. Other services include: <br></br>* Green building
                  cost consulting and life cycle cost analysis <br></br>*
                  Sustainability masterplanning <br></br>* Technology
                  due-diligence BREEAM SKA Home Quality Mark (HQM).
                </p>
              </Toggle2>
            </motion.div>
          </StyledCard>
          <StyledCard>
            <motion.div className="icon">
              ...
              <Toggle2>
                <p>
                  Supply chains are often opaque. We have significant experience
                  working with investors, multinationals and their supply chains
                  and have worked on this issue with (amongst others) UN
                  Principles for Responsible Investment and the Chartered
                  Institute for Purchase and Supply. Specific services include:
                  ● ESG (Environmental, Social and Governance) investor &
                  multi-national supply-chain engagement strategy and
                  implementation. ● TCFD assistance (Taskforce on Financial
                  Related Climate Disclosure) for both companies and investors.
                  Sustainable Development Goals (SDGs) - materiality and
            ...
            <motion.div className="icon">
              ...
              <Toggle2>
                <p>
                  ...
                  leading consultancies including Mott Macdonald, ERM, AECOM,
          ...
          <StyledCard>
            <motion.div className="icon">
              ...
              />
              <motion.h5>
                Corporate Responsibility, Risk Management and Reporting
              </motion.h5>
              <Toggle2>
                <p>
